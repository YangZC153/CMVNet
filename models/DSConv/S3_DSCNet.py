...
class DSCNet(nn.Module):
    def __init__(self, n_channels, n_classes, kernel_size, extend_scope, if_offset, device, number, dim):
        ...
        self.conv0x = DCN_Conv(n_channels, self.number, 3, self.extend_scope, 0, self.if_offset, self.device)  #  in_ch, out_ch, kernel_size, extend_scope, morph, if_offset, device
